...
!(function (e, i) {
	...
	return class {
		constructor(e, i, t) {
			__publicField(this, "form", null),
				...
				__publicField(this, "handleFieldChange", (e) => {
					...
					i &&
						((this.fields[i].touched = !0),
						this.validateField(i, !0));
				}),
				__publicField(this, "handleGroupChange", (e) => {
					...
					i &&
						((this.groupFields[i].touched = !0),
						this.validateGroup(i, !0));
				}),
		...
		getFieldSuccessMessage(e, i) {
			const t =
				"function" == typeof e
					? e(this.getElemValue(i), this.fields)
					: e;
		...
		validateFieldRule(o, a, n, c = !1) {
			...
			if (n.plugin) {
				n.plugin(h, this.getCompatibleFields()) ||
				...
				switch (n.rule) {
					...
					case r.Files: {
						...
						const i = (e, i) => {
							const t =
									Number.isFinite(i.minSize) &&
									e.size < i.minSize,
								s =
									Number.isFinite(i.maxSize) &&
									e.size > i.maxSize,
								l =
									Array.isArray(i.names) &&
									!i.names.includes(e.name),
								r =
		...
		isFormValid() {
			...
			for (
				let i = 0, t = Object.values(this.groupFields).length;
				i < t;
				++i
			) {
		...
		addField(e, i, t) {
			...
			let s;
			if (
				((s = "string" == typeof e ? this.form.querySelector(e) : e),
				!s)
			)
				throw Error(
		...
		addRequiredGroup(e, i, t, s) {
			...
			let l;
			if (
				((l = "string" == typeof e ? this.form.querySelector(e) : e),
				!l)
			)
				throw Error(
		...
		renderTooltip(e, i, t) {
			...
			const {
				...
				d =
					t ||
					(null == (s = this.globalConfig.tooltip)
						? void 0
						: s.position);
			switch (d) {
				case "left":
		...
		renderFieldLabel(e, i, t, s) {
			...
			if ("checkbox" === e.type || "radio" === e.type) {
				...
				"label" ===
				(null ==
				(r = null == (l = e.parentElement) ? void 0 : l.tagName)
					? void 0
					: r.toLowerCase())
					? null ==
							(a =
								null == (o = e.parentElement)
									? void 0
									: o.parentElement) || a.appendChild(i)
					: t
				...
				this.isTooltip() &&
					this.tooltips.push(
						this.renderTooltip(
							...
							null ==
								(n =
									null == (a = d.config) ? void 0 : a.tooltip)
								? void 0
								: n.position
						)
					);
				...
				this.isTooltip() &&
					this.tooltips.push(
						this.renderTooltip(
							...
							null ==
								(r =
									null == (l = o.config) ? void 0 : l.tooltip)
								? void 0
								: r.position
						)
					);
